...
def transform_and_inject_data():
    try:
        ...
        api_airports_response = get_rt_data.get_missing_airports(api_flights_df)
        api_fleets_response = get_rt_data.get_missing_aircraft(api_flights_df)
        ...
        print("Process tranform and inject data finished")
