...
def launch_etl():
    ...
    if api_fleets_response2 != None:
        ...
        inject_sql_aircrafts.inject_AIRCRAFT(AIRCRAFT, static.name_bdd)
    ...
    inject_sql_flights_summary.inject_sql_flights_summary(FLIGHTS_SUMMARY, static.name_bdd)
    ...
    inject_sql_flights_metrics.inject_sql_flights_metrics(FLIGHTS_METRICS, static.name_bdd)
